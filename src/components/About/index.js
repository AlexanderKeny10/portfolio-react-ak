    ...
    return (
        <section>
            ...
            <p className='bio'>
                My story
                <br/>
                I am a diligent and detail oriented video production and motion graphics editor with over 7 years of expreince and skills in nearly all fields of multimedia production. 
